# -*- coding: utf-8 -*-
# Generated by Django 1.11.20 on 2019-04-25 19:35
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('phone_link', models.CharField(blank=True, max_length=255, null=True)),
                ('phone_name', models.CharField(blank=True, max_length=255, null=True)),
                ('phone_price', models.CharField(blank=True, max_length=255, null=True)),
                ('phone_commits', models.CharField(blank=True, max_length=255, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(blank=True, max_length=255, null=True)),
                ('txt_info', models.CharField(blank=True, max_length=255, null=True)),
